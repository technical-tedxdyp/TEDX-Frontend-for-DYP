...
//   // ✅ ULTRA-MINIMAL Razorpay options to fix 400 error
//   const initiatePayment = async () => {
//     try {
//       if (!selectedSession) return;
...
//       // Create backend order (this part works fine)
//       const backendSessionKey = SESSION_KEY[selectedSession.name];
//       const orderPayload = { 
//         amount: selectedSession.price,
//         session: backendSessionKey,
...
//           verifyPayment(response);
//         }
//         // ❌ REMOVED: prefill, theme, description - all extra parameters
//       };
...
const TicketPage = () => {
  ...
  const initiatePayment = async () => {
    try {
      ...
      // Open Razorpay
      const options = {
        key: "rzp_test_KzB4idWWnf33y2", //Vineet
        amount: selectedSession.price * 100,
        currency: "INR",
        name: "TEDx DYP Akurdi",
        description: `${selectedSession.name} Ticket`,
